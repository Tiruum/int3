...
const Box: React.FC<BoxProps> = ({color, Icon, title, description, col}) => {
        return (
        <div
            className={`group flex ${col ? 'flex-col' : 'items-center'} whitespace-pre-wrap gap-4 rounded-xl bg-gradient-to-br p-4 border ${colorVariants[color].box} transition-all backdrop-blur-xs`}>
