...
const Functions: React.FC<FunctionsProps> = () => {
    ...
    const funcObj: FunctionsObj[] = [
        {
            ...
            description: 'Пользователям доступно несколько видов интеграторов, вариативность модели среды,\nа также маневры поддержания орбит.',
        ...
        },
        {
            ...
            description: 'Программный комплекс предоставляет функции расчета сеансов связи между космическими аппаратами и наземными станциями, а также позволяет учитывать межспутниковую связь\nи маршрутизацию данных.',
    ...
    return (
        <>
            <AnimatedText text={'Функционал программного комплекса'} className='font-bold text-white lg:text-5xl text-3xl leading-[125%] mb-12' />
