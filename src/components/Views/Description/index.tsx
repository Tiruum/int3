...
const features = [
    {
        ...
        title: "Моделирование",
        description: "Проведение математического и имитационного моделирования многоспутниковых группировок, отдельных космических аппаратов и их систем на различных этапах жизненного цикла космической системы.",
    ...
    },
    {
        ...
        title: "Расчет динамики",
        description: "Расчет динамики многоспутниковых группировок и выполнения ими целевых задач, предоставление математического описания функционирования космических аппаратов, входящих в состав группировок.",
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8" ref={containerRef}>
                {features.map((feature, index) => (
                    <div key={`description_${index}`}
                        ...
                        <p className="text-gray-400 text-justify">{feature.description}</p>
                    </div>
                ))}
            </div>
        </>
