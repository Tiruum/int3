...
const features = [
    {
        ...
        title: "Моделирование",
        description: "Проводить математические и имитационные моделирования многоспутниковых группировок, отдельных космических аппаратов (КА), а также систем КА на различных этапах жизненного цикла космической системы.",
        hoverBorderColor: "hover:border-blue-500"
    },
    {
        icon: <ChartMixed className="w-10 h-10 text-green-500" />,
        title: "Расчёт динамики",
        description: "Рассчитывать динамику многоспутниковых группировок, выполнение ими целевых задач и предоставляет математическое описание функционирования космических аппаратов, входящих в состав группировок.",
        hoverBorderColor: "hover:border-green-500"
    },
    {
        icon: <Rocket className="w-10 h-10 text-red-500" />,
        title: "Оптимальные решения",
        description: "Находить оптимальные решения, недостижимые при проектировании с использованием экспертных и аналитических подходов. Это позволяет исключить принятие ошибочных решений и впоследствии значительно сократить затраты при создании и применении многоспутниковых систем и комплексов.",
