    ...
    const organizations = [
        {
            ...
            description: 'Обоснование тактико-технических требований к космическим системам. Оценка эффективности и соответсвия требованиями существующих и перспективных систем.\n'
        },
        {
            icon: PiBracketsCurly,
            title: 'Разработчики космических систем и их компонентов',
            description: 'Проектирование и оптимизация системы и ее компонент, проведение виртуальных испытаний'
        },
        {
