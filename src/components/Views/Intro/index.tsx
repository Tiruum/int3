        ...
        <>
            <div id={id} className="relative w-full h-screen z-0">
                ...
                <div
                    ...
                    <h1 className="lg:text-[130px] ubuntu-mono-bold font-mono text-[46px] text-blue-500 lg:ml-52 ml-16 text-left leading-tight font-bold lg:-mt-6 -mt-2 -z-10"
                        id="integral">!N736r2@|_</h1>
                </div>
                ...
                {/*<div*/}
                {/*    className='absolute left-0 bottom-0 bg-gradient-radial-sky-500 w-full aspect-square opacity-[15%] -translate-x-1/2 translate-y-3/4 -z-10'></div>*/}
