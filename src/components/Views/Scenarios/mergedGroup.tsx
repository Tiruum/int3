    ...
    const slideshow = [
        {
            ...
            label: 'Задание компонентов: систем связи для обоих типов КА и камеры для КА ДЗЗ'
        },
        {
            id: 1,
            src: '/scenarios/mergedGroup/01.png',
            label: 'Задание конструкций КА ДЗЗ и КА связи'
        },
        {
            id: 2,
            src: '/scenarios/mergedGroup/02.png',
            label: 'Задание группировок КА'
        },
        {
            id: 3,
        ...
        },
        {
            ...
            label: 'Запуск расчёта'
        },
        {
            id: 8,
            src: '/scenarios/mergedGroup/08.png',
            label: 'Просмотр результатов расчёта'
        },
        {
            id: 9,
        ...
        },
        {
            ...
            label: 'Определение объёма загруженных станциями данных и времени ожидания сеанса связи для каждой станции'
        }]
        ...
        <>
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-8">
                <div className='space-y-2'>
                    ...
                    <p className='text-gray-100'>Это существенно ускоряет доставку данных ДЗЗ и время, необходимое для
                        съёмки точки по заявке потребителя.
                        В такой группировке КА ДЗЗ могут получать и передавать данные на землю через КА связи.
                    </p>
                    <p className='text-gray-100'>Данный сценарий позволяет оценить эффективность подобной группировки
                        при её проектировании.</p>
                </div>
