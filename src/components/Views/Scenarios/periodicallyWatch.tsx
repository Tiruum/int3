        ...
        <>
            ...
            <ol className="relative mt-8 border-s-2 border-gray-700 space-y-10">
                ...
                <Step images={slideshow.filter((point) => point.id > 4)} listName={'mergedGroup'}
                      ...
                      description={'В результате вычисления дневной периодичности (с учётом длительности светлой части суток),' +
                          'усреднённой по долготам, в каждом широтном поясе определена зависимость средней периодичности от широты.' +
