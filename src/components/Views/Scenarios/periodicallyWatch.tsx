        ...
        <>
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-8">
                <div className='space-y-2'>
                    ...
                    <p className='text-gray-100'>Большую роль при проектировании таких систем играет
                        правильное распределение космических аппаратов по орбитам.
            ...
            <ol className="relative mt-8 border-s-2 border-gray-700 space-y-10">
                ...
                <Step images={slideshow.filter((point) => point.id > 4)} listName={'mergedGroup'}
                      ...
                      description={'В результате вычисления дневной периодичности (с учетом длительности светлой части суток), усредненной по долготам, в каждом широтном поясе определена зависимость средней периодичности от широты. Обнаружено, что средняя периодичность обзора зависит от широты цели линейным образом и уменьшается с увеличением широты.'}
                />
            </ol>
        </>
    )
