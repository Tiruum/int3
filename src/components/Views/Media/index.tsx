    ...
    const articles: Article[] = [
        {
            ...
            source: 'Pikabu',
            date: new Date('2020-10-27'),
            text: 'Проекты по развертыванию орбитальных группировок из сотен спутников в виде систем OneWeb, Starlink или российской «Сферы» требуют тщательного проектирования и учитывают столько факторов, что без развитого программного обеспечения никак не обойтись.',
